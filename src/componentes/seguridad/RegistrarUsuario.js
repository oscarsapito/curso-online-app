...
const RegistrarUsuario =() => {
    const [usuario, setUsuario] = useState({    //Variable de estado 'usuario'
        NombreCompleto : '',
        Email          : '',
        Password       : '',
        ConfirmaPassword: '',
            ...
            <div style={style.paper}>
                ...
                <form style={style.form}>
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} md={6}>
                            <TextField name="ConfirmaPassword" value={usuario.ConfirmaPassword} onChange={ingresarValoresMemoria} type="password" variant="outlined" fullWidth label="Confirme password"/> 
                        </Grid>
                    </Grid>
